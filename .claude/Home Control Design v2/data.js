...
(function () {
  ...
  // Garage roller doors (open/close actuators, not locks)
  const garageDoors = [
    { id: 'gd-workshop', name: 'Workshop',       open: false },
    { id: 'gd-jeanette', name: "Jeanette's Car", open: false },
    { id: 'gd-greg',     name: "Greg's Car",     open: true  },
    { id: 'gd-kids',     name: "Kid's Car",      open: false },
  ];
  const doorsInterior = [
  ...
  garageDoors.forEach(d => state[d.id] = { open: d.open });
  ...
  const favCatalog = [
    ...
    { group: 'Garage', items: [
      { id: 'gd-workshop',  icon: 'garage', label: 'Workshop' },
      { id: 'gd-jeanette',  icon: 'garage', label: "Jeanette's Car" },
      { id: 'gd-greg',      icon: 'garage', label: "Greg's Car" },
      { id: 'gd-kids',      icon: 'garage', label: "Kid's Car" },
    ]},
    { group: 'Music', items: [
  ...
  window.HC = {
    ...
    doorsExterior, garageDoors, doorsInterior, climate, musicZones, fans,
