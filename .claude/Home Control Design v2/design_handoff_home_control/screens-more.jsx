...
const { LargeTitle: LT, Tile: Tl, iconBtn: IB, pillBtn: PB } = window;
...
Object.assign(window, { MusicScreen, FansScreen, IrrigationScreen, LeakScreen, MotionScreen, OutdoorsScreen, SettingsScreen, MoreScreen, CustomizeScreen, DocsScreen });
