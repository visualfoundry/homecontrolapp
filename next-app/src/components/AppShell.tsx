...
import { ServiceHealthStrip } from '@/components/ServiceHealth';
  ...
  return (
    <div className="hca-shell">
      ...
      <div className="hca-shell-main">
        ...
        {/* Outage indication at template level, so no screen looks trustworthy
            while the house isn't. Home carries the full message in-page, so it is
            excluded here rather than saying the same thing twice. Below the
            scroll area so it can't be scrolled out of sight while it applies. */}
        {current !== 'home' && <ServiceHealthStrip />}
